...
function my_theme_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			'name'               => 'symbol slider', // The plugin name.
			'slug'               => 'symbol-posttype-plugin', // The plugin slug (typically the folder name).
			'source'             => get_stylesheet_directory() . '/inc/plugins/plugins/symbol-posttype-plugin.zip', // The plugin source.
